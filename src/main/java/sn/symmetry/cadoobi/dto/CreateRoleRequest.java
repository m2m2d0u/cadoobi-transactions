...
public class CreateRoleRequest {
    ...
    @Schema(description = "Unique role code (uppercase with underscores)", example = "MERCHANT_MANAGER", required = true)
    ...
    @Schema(description = "Whether role is active", example = "true", defaultValue = "true")
    @Builder.Default
