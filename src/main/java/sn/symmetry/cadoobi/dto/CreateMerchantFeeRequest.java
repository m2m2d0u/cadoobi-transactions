...
@AllArgsConstructor
@Builder
@Schema(description = "Request payload for creating a merchant payout fee configuration")
public class CreateMerchantFeeRequest {

    @Schema(description = "Type of fee calculation method", example = "PERCENTAGE", required = true)
    @NotNull(message = "Fee type is required")
    private FeeType feeType;

    @Schema(description = "Fee percentage (0.0 to 1.0 representing 0% to 100%)", example = "0.02")
    ...
    @Schema(description = "Date until which this fee is effective (null = no expiry)", example = "2024-12-31")
