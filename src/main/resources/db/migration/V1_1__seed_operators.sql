...
VALUES
    ...
    (gen_random_uuid(), 'OM', 'Orange Money', 'SN', TRUE, TRUE, 'https://api.orange.sn', TRUE, NOW(), NOW()),
    (gen_random_uuid(), 'FREE', 'Free Money', 'SN', TRUE, TRUE, 'https://api.free.sn', TRUE, NOW(), NOW());
